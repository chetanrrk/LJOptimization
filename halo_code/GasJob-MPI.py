...
def computeGrads():
	...
	str_L_Box = '%f' %(L_Box)
	if not os.path.isfile("dE_dvdw_gas.txt"):
	    os.system("/lcrc/project/Drude/chetan/workspace/ljopt-tests/drude_lj_prod/code_grad_gas_halos/grad_gas ../ff.str ../mol-drude-gas.xpsf "+str(temp)+" 1000000 0.001 "+str_L_Box+" 0 > log.txt")	
